...
namespace CrowdControl.Games.Packs.Tomb123
{
    ...
    public class Tomb123 : InjectEffectPack
    {
        ...
        public override EffectList Effects { get; } = new List<Effect>
        {
            ...
            new("TR1 Classic Outfit", GameEffect.classic1Outfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into TR1's classic outfit", Category = BuildCategories(GameEffect.classic1Outfit, CosmeticEffects)},
            new("TR1 Training Outfit", GameEffect.training1Outfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into TR1's training outfit", Category = BuildCategories(GameEffect.training1Outfit, CosmeticEffects)},
            new("TR2 Classic Outfit", GameEffect.classic2Outfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into TR2's classic outfit", Category = BuildCategories(GameEffect.classic2Outfit, CosmeticEffects)},
            new("TR2 Training Outfit", GameEffect.training2Outfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into TR2's training outfit", Category = BuildCategories(GameEffect.training2Outfit, CosmeticEffects)},
            new("Wetsuit Outfit", GameEffect.wetsuitOutfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into the wetsuit outfit", Category = BuildCategories(GameEffect.wetsuitOutfit, CosmeticEffects)},
            new("Bomber Outfit", GameEffect.bomberOutfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into the bomber outfit", Category = BuildCategories(GameEffect.bomberOutfit, CosmeticEffects)},
            new("Bathrobe Outfit", GameEffect.bathrobeOutfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into the bathrobe outfit", Category = BuildCategories(GameEffect.bathrobeOutfit, CosmeticEffects)},
            new("TR3 Training Outfit", GameEffect.training3Outfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into TR3's training outfit", Category = BuildCategories(GameEffect.training3Outfit, CosmeticEffects)},
            new("Nevada Outfit", GameEffect.nevadaOutfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into the Nevada outfit", Category = BuildCategories(GameEffect.nevadaOutfit, CosmeticEffects)},
            new("Pacific Outfit", GameEffect.pacificOutfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into the Pacific outfit", Category = BuildCategories(GameEffect.pacificOutfit, CosmeticEffects)},
            new("Catsuit Outfit", GameEffect.catsuitOutfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into the catsuit outfit", Category = BuildCategories(GameEffect.catsuitOutfit, CosmeticEffects)},
            new("Antarctica Outfit", GameEffect.antarcticaOutfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into the Antarctica outfit", Category = BuildCategories(GameEffect.antarcticaOutfit, CosmeticEffects)},
            new("Bloody Classic Outfit", GameEffect.bloodyClassicOutfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into the bloody classic outfit", Category = BuildCategories(GameEffect.bloodyClassicOutfit, CosmeticEffects)},
            new("OG Outfit", GameEffect.ogLaraOutfit.ToString()) { Image = "outfit",  Price = 10, Description = "Change Lara into OG Lara in remastered graphics", Category = BuildCategories(GameEffect.ogLaraOutfit, CosmeticEffects)},
            new("Vegas Outfit", GameEffect.vegasOutfit.ToString()) { Image = "outfit", Price = 10, Description = "Change Lara into the Vegas outfit", Category = BuildCategories(GameEffect.vegasOutfit, CosmeticEffects)},
            ...
            new("Double Pistol Damage", GameEffect.doublePistolDamage.ToString()) { Image = "double_damage", Price = 100, Description = "Double the damage Lara's pistols deal", Category = BuildCategories(GameEffect.doublePistolDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Shotgun Damage", GameEffect.doubleShotgunDamage.ToString()) { Image = "double_damage", Price = 100, Description = "Double the damage Lara's Shotgun deals", Category = BuildCategories(GameEffect.doubleShotgunDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Uzi Damage", GameEffect.doubleUziDamage.ToString()) { Image = "double_damage", Price = 100, Description = "Double the damage Lara's Uzis deal", Category = BuildCategories(GameEffect.doubleUziDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Pistol Damage", GameEffect.disablePistolDamage.ToString()) { Image = "disable_damage", Price = 100, Description = "Disable Lara's pistols from dealing damage", Category = BuildCategories(GameEffect.disablePistolDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Shotgun Damage", GameEffect.disableShotgunDamage.ToString()) { Image = "disable_damage", Price = 100, Description = "Disable Lara's Shotgun from dealing damage", Category = BuildCategories(GameEffect.disableShotgunDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Uzi Damage", GameEffect.disableUziDamage.ToString()) { Image ="disable_damage" , Price=100 , Description="Disable Lara's Uzis from dealing damage" , Category=BuildCategories(GameEffect.disableUziDamage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            new("Double Magnum Damage", GameEffect.tr1DoubleMagnumDamage.ToString()) { Image = "double_damage", Note = "TR1", Price = 100, Description = "Double the damage Lara's Magnums deal", Category = BuildCategories(GameEffect.tr1DoubleMagnumDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Magnum Damage", GameEffect.tr1DisableMagnumDamage.ToString()) { Image = "disable_damage", Note = "TR1", Price = 100, Description = "Disable Lara's Magnums from dealing damage", Category = BuildCategories(GameEffect.tr1DisableMagnumDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Harpoon Damage", GameEffect.doubleHarpoonDamage.ToString()) { Image = "double_damage", Note = "TR2/TR3", Price = 100, Description = "Double the damage Lara's Harpoon Gun deals", Category = BuildCategories(GameEffect.doubleHarpoonDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Harpoon Damage", GameEffect.disableHarpoonDamage.ToString()) { Image ="disable_damage" , Note="TR2/TR3" , Price=100 , Description="Disable Lara's Harpoon Gun from dealing damage" , Category=BuildCategories(GameEffect.disableHarpoonDamage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            new("Double Automatic Pistols Damage", GameEffect.doubleAutoPistolsDamage.ToString()) { Image ="double_damage" , Note="TR2" , Price=100 , Description="Double the damage Lara's Automatic Pistols deal" , Category=BuildCategories(GameEffect.doubleAutoPistolsDamage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            new("Disable Automatic Pistols Damage", GameEffect.disableAutoPistolsDamage.ToString()) { Image ="disable_damage" , Note="TR2" , Price=100 , Description="Disable Lara's Automatic Pistols from dealing damage" , Category=BuildCategories(GameEffect.disableAutoPistolsDamage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            new("Double M16 Damage", GameEffect.doubleM16Damage.ToString()) { Image = "double_damage", Note = "TR2", Price = 100, Description = "Double the damage Lara's M16 deals", Category = BuildCategories(GameEffect.doubleM16Damage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable M16 Damage", GameEffect.disableM16Damage.ToString()) { Image = "disable_damage", Note = "TR2", Price = 100, Description = "Disable Lara's M16 from dealing damage", Category = BuildCategories(GameEffect.disableM16Damage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Desert Eagle Damage", GameEffect.doubleDeagleDamage.ToString()) { Image = "double_damage", Note = "TR3",Price = 100, Description = "Double the damage Lara's Desert Eagle deals", Category = BuildCategories(GameEffect.doubleDeagleDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Desert Eagle Damage", GameEffect.disableDeagleDamage.ToString()) { Image ="disable_damage" , Note="TR3" , Price=100 , Description="Disable Lara's Desert Eagle from dealing damage" , Category=BuildCategories(GameEffect.disableDeagleDamage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            new("Double MP5 Damage", GameEffect.doubleMP5Damage.ToString()) { Image ="double_damage" , Note="TR3" , Price=100 , Description="Double the damage Lara's MP5 deals" , Category=BuildCategories(GameEffect.doubleMP5Damage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            new("Disable MP5 Damage", GameEffect.disableMP5Damage.ToString()) { Image ="disable_damage" , Note="TR3" , Price=100 , Description="Disable Lara's MP5 from dealing damage" , Category=BuildCategories(GameEffect.disableMP5Damage,OtherEffects) , Duration=30 , IsDurationEditable=true},
            ...
            new("Give Shotgun", GameEffect.giveShotgun.ToString()) { Image = "give_weapon", Price = 50, Description="Put Lara's shotgun in her backpack", Category=BuildCategories(GameEffect.giveShotgun, BackpackEffects) },
            new("Take Shotgun", GameEffect.takeShotgun.ToString()) { Image = "take_weapon", Price = 50, Description="Take Lara's shotgun out of her backpack", Category=BuildCategories(GameEffect.takeShotgun, BackpackEffects)},
            new("Give Uzis", GameEffect.giveUzis.ToString()) { Image = "give_weapon", Price = 50, Description="Put Lara's Uzis in her backpack", Category=BuildCategories(GameEffect.giveUzis, BackpackEffects) },
            new("Take Uzis", GameEffect.takeUzis.ToString()) { Image = "take_weapon", Price = 50, Description="Take Lara's Uzis out of her backpack", Category=BuildCategories(GameEffect.takeUzis, BackpackEffects)},
            new("Give Magnums", GameEffect.tr1GiveMagnums.ToString()) { Note = "TR1", Image = "give_weapon", Price = 50, Description="Put Lara's Magnums in her backpack", Category=BuildCategories(GameEffect.tr1GiveMagnums, BackpackEffects) },
            new("Take Magnums", GameEffect.tr1TakeMagnums.ToString()) { Note = "TR1", Image = "take_weapon", Price = 50, Description="Take Lara's Magnums out of her backpack", Category=BuildCategories(GameEffect.tr1TakeMagnums, BackpackEffects)},
            new("Give Automatic Pistols", GameEffect.giveAutoPistols.ToString()) { Image = "give_weapon", Note = "TR2", Price = 50, Description="Put Lara's Automatic Pistols in her backpack", Category=BuildCategories(GameEffect.giveAutoPistols, BackpackEffects) },
            new("Take Automatic Pistols", GameEffect.takeAutoPistols.ToString()) { Image = "take_weapon", Note = "TR2", Price = 50, Description="Take Lara's Automatic Pistols out of her backpack", Category=BuildCategories(GameEffect.takeAutoPistols, BackpackEffects)},
            new("Give M16", GameEffect.giveM16.ToString()) { Image = "give_weapon", Note = "TR2", Price = 50, Description="Put Lara's M16 in her backpack", Category=BuildCategories(GameEffect.giveM16, BackpackEffects) },
            new("Take M16", GameEffect.takeM16.ToString()) { Image = "take_weapon", Note = "TR2", Price = 50, Description="Take Lara's M16 out of her backpack", Category=BuildCategories(GameEffect.takeM16, BackpackEffects)},
            new("Give Grenade Launcher", GameEffect.giveGrenadeLauncher.ToString()) { Image = "give_weapon", Note = "TR2/TR3", Price = 50, Description="Put Lara's Grenade Launcher in her backpack", Category=BuildCategories(GameEffect.giveGrenadeLauncher, BackpackEffects) },
            new("Take Grenade Launcher", GameEffect.takeGrenadeLauncher.ToString()) { Image = "take_weapon", Note = "TR2/TR3", Price = 50, Description="Take Lara's Grenade Launcher out of her backpack", Category=BuildCategories(GameEffect.takeGrenadeLauncher, BackpackEffects)},
            new("Give Harpoon Gun", GameEffect.giveHarpoonGun.ToString()) { Image = "give_weapon", Note = "TR2/TR3", Price = 50, Description="Put Lara's Harpoon Gun in her backpack", Category=BuildCategories(GameEffect.giveHarpoonGun, BackpackEffects) },
            new("Take Harpoon Gun", GameEffect.takeHarpoonGun.ToString()) { Image = "take_weapon", Note = "TR2/TR3", Price = 50, Description="Take Lara's Harpoon Gun out of her backpack", Category=BuildCategories(GameEffect.takeHarpoonGun, BackpackEffects)},
            new("Give Desert Eagle", GameEffect.giveDesertEagle.ToString()) { Image = "give_weapon", Note = "TR3", Price = 50, Description="Put Lara's Desert Eagle in her backpack", Category=BuildCategories(GameEffect.giveDesertEagle, BackpackEffects) },
            new("Take Desert Eagle", GameEffect.takeDesertEagle.ToString()) { Image = "take_weapon", Note = "TR3", Price = 50, Description="Take Lara's Desert Eagle out of her backpack", Category=BuildCategories(GameEffect.takeDesertEagle, BackpackEffects)},
            new("Give MP5", GameEffect.giveMP5.ToString()) { Image = "give_weapon", Note = "TR3", Price = 50, Description="Put Lara's MP5 in her backpack", Category=BuildCategories(GameEffect.giveMP5, BackpackEffects)},
            new("Take MP5",  GameEffect.takeMP5.ToString()) { Image = "take_weapon", Note = "TR3", Price = 50, Description="Take Lara's MP5 out of her backpack", Category=BuildCategories(GameEffect.takeMP5, BackpackEffects)},
            new("Give Rocket Launcher", GameEffect.giveRocketLauncher.ToString()) { Image = "give_weapon", Note = "TR3",Price = 50, Description="Put Lara's Rocket Launcher in her backpack", Category=BuildCategories(GameEffect.giveRocketLauncher, BackpackEffects) },
            new("Take Rocket Launcher", GameEffect.takeRocketLauncher.ToString()) { Image = "take_weapon", Note = "TR3", Price = 50, Description="Take Lara's Rocket Launcher out of her backpack", Category=BuildCategories(GameEffect.takeRocketLauncher, BackpackEffects)},
            #endregion
            ...
            new("Give Shotgun Ammo", GameEffect.giveShotgunAmmo.ToString()) { Image = "give_ammo", Price = 10, Description="Give Lara 2 shotgun shells", Category= BuildCategories(GameEffect.giveShotgunAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Shotgun Ammo", GameEffect.takeShotgunAmmo.ToString()) { Image = "take_ammo", Price = 10, Description="Take 2 of Lara's shotgun shells", Category= BuildCategories(GameEffect.takeShotgunAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Uzi Ammo", GameEffect.giveUziAmmo.ToString()) { Image = "give_ammo", Price = 10, Description="Give Lara 50 Uzi bullets", Category= BuildCategories(GameEffect.giveUziAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Uzi Ammo", GameEffect.takeUziAmmo.ToString()) { Image = "take_ammo", Price = 10, Description="Take 50 of Lara's Uzi bullets", Category= BuildCategories(GameEffect.takeUziAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Magnum Ammo", GameEffect.tr1GiveMagnumAmmo.ToString()) { Note ="TR1", Image = "give_ammo", Price = 25, Description="Give Lara 25 Magnum bullets", Category= BuildCategories(GameEffect.tr1GiveMagnumAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Magnum Ammo", GameEffect.tr1TakeMagnumAmmo.ToString()) { Note = "TR1", Image = "take_ammo", Price = 25, Description="Take 25 of Lara's Magnum bullets", Category= BuildCategories(GameEffect.tr1TakeMagnumAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Automatic Pistol Ammo", GameEffect.giveAutoPistolAmmo.ToString()) { Note = "TR2", Image = "give_ammo", Price = 10, Description="Give Lara 25 automatic pistol bullets", Category = BuildCategories(GameEffect.giveAutoPistolAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Automatic Pistol Ammo", GameEffect.takeAutoPistolAmmo.ToString()) { Note = "TR2", Image = "take_ammo", Price = 10, Description="Take 25 of Lara's automatic pistol bullets", Category = BuildCategories(GameEffect.takeAutoPistolAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give M16 Ammo", GameEffect.giveM16Ammo.ToString()) { Note = "TR2", Image = "give_ammo", Price = 10, Description="Give Lara 30 M16 bullets", Category=BuildCategories(GameEffect.giveM16Ammo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take M16 Ammo", GameEffect.takeM16Ammo.ToString()) { Note = "TR2", Image = "take_ammo", Price = 10, Description="Take 30 of Lara's M16 bullets", Category=BuildCategories(GameEffect.takeM16Ammo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Grenades", GameEffect.giveGrenadeAmmo.ToString()) { Note = "TR2/TR3", Image = "give_ammo", Price = 10, Description="Give Lara 2 grenades", Category=BuildCategories(GameEffect.giveGrenadeAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Grenades", GameEffect.takeGrenadeAmmo.ToString()) { Note = "TR2/TR3", Image ="take_ammo" , Price = 10, Description="Take 2 of Lara's grenades", Category=BuildCategories(GameEffect.takeGrenadeAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Harpoons", GameEffect.giveHarpoonAmmo.ToString()) { Note = "TR2/TR3", Image ="give_ammo" , Price = 10, Description="Give Lara 4 harpoons", Category=BuildCategories(GameEffect.giveHarpoonAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Harpoons", GameEffect.takeHarpoonAmmo.ToString()) { Note ="TR2/TR3", Image ="take_ammo" , Price= 10, Description="Take 4 of Lara's harpoons", Category= BuildCategories(GameEffect.takeHarpoonAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give MP5 Ammo", GameEffect.giveMP5Ammo.ToString()) { Note ="TR3", Image ="give_ammo" , Price = 10, Description="Give Lara 50 MP5 bullets", Category=BuildCategories(GameEffect.giveMP5Ammo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Give Desert Eagle Ammo", GameEffect.giveDeagleAmmo.ToString()) { Note = "TR3", Image ="give_ammo", Price = 10, Description="Give Lara 7 Desert Eagle bullets", Category= BuildCategories(GameEffect.giveDeagleAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Desert Eagle Ammo", GameEffect.takeDeagleAmmo.ToString()) { Note = "TR3", Image ="take_ammo", Price = 10, Description="Take 7 of Lara's Desert Eagle bullets", Category= BuildCategories(GameEffect.takeDeagleAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Rockets", GameEffect.giveRocketAmmo.ToString()) { Note = "TR3", Image ="give_ammo", Price = 10, Description="Give Lara 2 rockets", Category= BuildCategories(GameEffect.giveRocketAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Rockets", GameEffect.takeRocketAmmo.ToString()) { Note = "TR3", Image ="take_ammo", Price = 10, Description="Take 2 of Lara's rockets", Category= BuildCategories(GameEffect.takeRocketAmmo, AmmoEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF)},
