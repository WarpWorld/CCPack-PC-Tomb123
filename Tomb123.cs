...
namespace CrowdControl.Games.Packs.Tomb123
{
    ...
    public class Tomb123 : InjectEffectPack
    {
        ...
        public override EffectList Effects { get; } = new List<Effect>
        {
            ...
            new("Dark Lara", GameEffect.darkLara.ToString()) { Price = 50, Description = "Turn Lara into Dark Lara(forces OG graphics)", Category = BuildCategories(GameEffect.darkLara, OtherEffects), Duration = 30, IsDurationEditable = true},
            ...
            new("Double Magnum Damage", GameEffect.tr1DoubleMagnumDamage.ToString()) { Price = 100, Description = "Double the damage Lara's Magnums deal", Category = BuildCategories(GameEffect.tr1DoubleMagnumDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Magnum Damage", GameEffect.tr1DisableMagnumDamage.ToString()) { Price = 100, Description = "Disable Lara's Magnums from dealing damage", Category = BuildCategories(GameEffect.tr1DisableMagnumDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Harpoon Damage", GameEffect.doubleHarpoonDamage.ToString()) { Price = 100, Description = "Double the damage Lara's Harpoon Gun deals", Category = BuildCategories(GameEffect.doubleHarpoonDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Harpoon Damage", GameEffect.disableHarpoonDamage.ToString()) { Price = 100, Description = "Disable Lara's Harpoon Gun from dealing damage", Category = BuildCategories(GameEffect.disableHarpoonDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Automatic Pistols Damage", GameEffect.doubleAutoPistolsDamage.ToString()) { Price = 100, Description = "Double the damage Lara's Automatic Pistols deal", Category = BuildCategories(GameEffect.doubleAutoPistolsDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Automatic Pistols Damage", GameEffect.disableAutoPistolsDamage.ToString()) { Price = 100, Description = "Disable Lara's Automatic Pistols from dealing damage", Category = BuildCategories(GameEffect.disableAutoPistolsDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double M16 Damage", GameEffect.doubleM16Damage.ToString()) { Price = 100, Description = "Double the damage Lara's M16 deals", Category = BuildCategories(GameEffect.doubleM16Damage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable M16 Damage", GameEffect.disableM16Damage.ToString()) { Price = 100, Description = "Disable Lara's M16 from dealing damage", Category = BuildCategories(GameEffect.disableM16Damage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double Desert Eagle Damage", GameEffect.doubleDeagleDamage.ToString()) { Price = 100, Description = "Double the damage Lara's Desert Eagle deals", Category = BuildCategories(GameEffect.doubleDeagleDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable Desert Eagle Damage", GameEffect.disableDeagleDamage.ToString()) { Price = 100, Description = "Disable Lara's Desert Eagle from dealing damage", Category = BuildCategories(GameEffect.disableDeagleDamage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Double MP5 Damage", GameEffect.doubleMP5Damage.ToString()) { Price = 100, Description = "Double the damage Lara's MP5 deals", Category = BuildCategories(GameEffect.doubleMP5Damage, OtherEffects), Duration = 30, IsDurationEditable = true},
            new("Disable MP5 Damage", GameEffect.disableMP5Damage.ToString()) { Price = 100, Description = "Disable Lara's MP5 from dealing damage", Category = BuildCategories(GameEffect.disableMP5Damage, OtherEffects), Duration = 30, IsDurationEditable = true},
            ...
            new("Give Flare", GameEffect.giveFlare.ToString()) { Price = 10, Description="Give Lara a flare", Category = BuildCategories(GameEffect.giveFlare, BackpackEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Flare", GameEffect.takeFlare.ToString()) { Price = 10, Description="Take away one of Lara's flares", Category = BuildCategories(GameEffect.takeFlare, BackpackEffects), DefaultQuantity = 1, Quantity = new QuantityRange(1, 0x7FFF) },
            ...
            new("Give Magnums", GameEffect.tr1GiveMagnums.ToString()) { Price = 50, Description="Put Lara's Magnums in her backpack", Category=BuildCategories(GameEffect.tr1GiveMagnums, BackpackEffects) },
            new("Take Magnums", GameEffect.tr1TakeMagnums.ToString()) { Price = 50, Description="Take Lara's Magnums out of her backpack", Category=BuildCategories(GameEffect.tr1TakeMagnums, BackpackEffects)},
            new("Give Automatic Pistols", GameEffect.giveAutoPistols.ToString()) { Price = 50, Description="Put Lara's Automatic Pistols in her backpack", Category=BuildCategories(GameEffect.giveAutoPistols, BackpackEffects) },
            new("Take Automatic Pistols", GameEffect.takeAutoPistols.ToString()) { Price = 50, Description="Take Lara's Automatic Pistols out of her backpack", Category=BuildCategories(GameEffect.takeAutoPistols, BackpackEffects)},
            new("Give M16", GameEffect.giveM16.ToString()) { Price = 50, Description="Put Lara's M16 in her backpack", Category=BuildCategories(GameEffect.giveM16, BackpackEffects) },
            new("Take M16", GameEffect.takeM16.ToString()) { Price = 50, Description="Take Lara's M16 out of her backpack", Category=BuildCategories(GameEffect.takeM16, BackpackEffects)},
            new("Give Grenade Launcher", GameEffect.giveGrenadeLauncher.ToString()) { Price = 50, Description="Put Lara's Grenade Launcher in her backpack", Category=BuildCategories(GameEffect.giveGrenadeLauncher, BackpackEffects) },
            new("Take Grenade Launcher", GameEffect.takeGrenadeLauncher.ToString()) { Price = 50, Description="Take Lara's Grenade Launcher out of her backpack", Category=BuildCategories(GameEffect.takeGrenadeLauncher, BackpackEffects)},
            new("Give Harpoon Gun", GameEffect.giveHarpoonGun.ToString()) { Price = 50, Description="Put Lara's Harpoon Gun in her backpack", Category=BuildCategories(GameEffect.giveHarpoonGun, BackpackEffects) },
            new("Take Harpoon Gun", GameEffect.takeHarpoonGun.ToString()) { Price = 50, Description="Take Lara's Harpoon Gun out of her backpack", Category=BuildCategories(GameEffect.takeHarpoonGun, BackpackEffects)},
            new("Give Desert Eagle", GameEffect.giveDesertEagle.ToString()) { Price = 50, Description="Put Lara's Desert Eagle in her backpack", Category=BuildCategories(GameEffect.giveDesertEagle, BackpackEffects) },
            new("Take Desert Eagle", GameEffect.takeDesertEagle.ToString()) { Price = 50, Description="Take Lara's Desert Eagle out of her backpack", Category=BuildCategories(GameEffect.takeDesertEagle, BackpackEffects)},
            new("Give MP5", GameEffect.giveMP5.ToString()) { Price = 50, Description="Put Lara's MP5 in her backpack", Category=BuildCategories(GameEffect.giveMP5, BackpackEffects)},
            new("Take MP5",  GameEffect.takeMP5.ToString()) { Price = 50, Description="Take Lara's MP5 out of her backpack", Category=BuildCategories(GameEffect.takeMP5, BackpackEffects)},
            new("Give Rocket Launcher", GameEffect.giveRocketLauncher.ToString()) { Price = 50, Description="Put Lara's Rocket Launcher in her backpack", Category=BuildCategories(GameEffect.giveRocketLauncher, BackpackEffects) },
            new("Take Rocket Launcher", GameEffect.takeRocketLauncher.ToString()) { Price = 50, Description="Take Lara's Rocket Launcher out of her backpack", Category=BuildCategories(GameEffect.takeRocketLauncher, BackpackEffects)},
            #endregion
            ...
            new("Give Magnum Ammo", GameEffect.tr1GiveMagnumAmmo.ToString()) { Price = 10, Description="Give Lara more Magnum bullets", Category= BuildCategories(GameEffect.tr1GiveMagnumAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Magnum Ammo", GameEffect.tr1TakeMagnumAmmo.ToString()) { Price = 10, Description="Take some of Lara's Magnum bullets", Category= BuildCategories(GameEffect.tr1TakeMagnumAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Automatic Pistol Ammo", GameEffect.giveAutoPistolAmmo.ToString()) { Price = 10, Description="Give Lara more automatic pistol bullets", Category = BuildCategories(GameEffect.giveAutoPistolAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Automatic Pistol Ammo", GameEffect.takeAutoPistolAmmo.ToString()) { Price = 10, Description="Take some of Lara's automatic pistol bullets", Category = BuildCategories(GameEffect.takeAutoPistolAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give M16 Ammo", GameEffect.giveM16Ammo.ToString()) { Price = 10, Description="Give Lara more M16 bullets", Category=BuildCategories(GameEffect.giveM16Ammo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take M16 Ammo", GameEffect.takeM16Ammo.ToString()) { Price = 10, Description="Take some of Lara's M16 bullets", Category=BuildCategories(GameEffect.takeM16Ammo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Grenades", GameEffect.giveGrenadeAmmo.ToString()) { Price = 10, Description="Give Lara more grenades", Category=BuildCategories(GameEffect.giveGrenadeAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Grenades", GameEffect.takeGrenadeAmmo.ToString()) { Price = 10, Description="Take some of Lara's grenades", Category=BuildCategories(GameEffect.takeGrenadeAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Harpoons", GameEffect.giveHarpoonAmmo.ToString()) { Price = 10, Description="Give Lara more harpoons", Category=BuildCategories(GameEffect.giveHarpoonAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Harpoons", GameEffect.takeHarpoonAmmo.ToString()) { Price = 10, Description="Take some of Lara's harpoons", Category= BuildCategories(GameEffect.takeHarpoonAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give MP5 Ammo", GameEffect.giveMP5Ammo.ToString()) { Price = 10, Description="Give Lara more MP5 bullets", Category= BuildCategories(GameEffect.giveMP5Ammo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take MP5 Ammo", GameEffect.takeMP5Ammo.ToString()) { Price = 10, Description="Take some of Lara's MP5 bullets", Category= BuildCategories(GameEffect.takeMP5Ammo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Desert Eagle Ammo", GameEffect.giveDeagleAmmo.ToString()) { Price = 10, Description="Give Lara more Desert Eagle bullets", Category= BuildCategories(GameEffect.giveDeagleAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Desert Eagle Ammo", GameEffect.takeDeagleAmmo.ToString()) { Price = 10, Description="Take some of Lara's Desert Eagle bullets", Category= BuildCategories(GameEffect.takeDeagleAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            new("Give Rockets", GameEffect.giveRocketAmmo.ToString()) { Price = 10, Description="Give Lara more rockets", Category= BuildCategories(GameEffect.giveRocketAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF) },
            new("Take Rockets", GameEffect.takeRocketAmmo.ToString()) { Price = 10, Description="Take some of Lara's rockets", Category= BuildCategories(GameEffect.takeRocketAmmo, AmmoEffects), DefaultQuantity = 25, Quantity = new QuantityRange(1, 0x7FFF)},
            ...
            new("Disable Stamina", GameEffect.disableStamina.ToString()) { Price = 200, Description = "Disable Lara from using stamina for some time", Category = BuildCategories(GameEffect.disableStamina, MeterEffects), Duration = 30, IsDurationEditable =true},
            new("Half Stamina", GameEffect.halfStamina.ToString()) { Price = 100, Description = "Set Lara's max stamina to 1/2 for some time", Category = BuildCategories(GameEffect.halfStamina, MeterEffects), Duration = 30, IsDurationEditable =true},
            new("Infinite Stamina", GameEffect.infiniteStamina.ToString()) { Price = 200, Description = "Give Lara infinite stamina for some time", Category = BuildCategories(GameEffect.infiniteStamina, MeterEffects), Duration = 30, IsDurationEditable =true},
            #endregion
        };
